...
package Net::Amazon::Validate::ItemSearch::fr::Toys;
...
sub find_match {
    ...
    die "$value is not a valid value for fr::Toys!\n";
}
...
Net::Amazon::Validate::ItemSearch::fr::Toys - valid search indicies
for the fr locale and the Toys SearchIndex.
